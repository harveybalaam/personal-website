...
const projects: Project[] = [
  ...
  },
  {
    ...
    keyTakeaways:
      "Although I interact with recommender systems almost every day, before this module I had never really known how they actually operated under the hood. It was interesting to learn about the theoretical concepts behing creating recommendations, and how we can deal with problems I had never even considered, for example the variance in the range of reviews users give, when determining how to weight each. I enjoyed also the process of building my own system, from dataset selection, data preparation, to model fitting and tuning, as well as evaluation metric selection and calculation. On that note, it also demonstrated to me the value in basing my design choices on strong empirical analysis, especially for systems with so many variables.",
