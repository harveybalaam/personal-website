      ...
      <div className="hello-body">
        <Container title="Introduction">
          <p>
            ...
            <br />
            <br />
            As you may have noticed, I&apos;ve tried to recreate the vibe of a
            TUI application with this site. My aim is to create something that
            is not just functional, but also enjoyable to interact with. While
            I&apos;m not sure this site will ever be &quot;done&quot;, I hope
            you feel that I am at least heading in that direction! :)
          </p>
        </Container>
